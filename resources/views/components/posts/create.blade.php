<div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
    ...
    <form action="#">
        <div class="mb-2">
            ...
            <input type="text" name="title" id="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type post itle" required="">
        </div>
        <div class="mb-2">
        ...
        <div class="flex gap-2">
            ...
            class="inline-flex rounded-lg items-center px-5 py-2.5 focus:ring-4  bg-red-600 hover:bg-red-800 text-white">
