        ...
        <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            <div class="flex gap-4 mb-4">
                <button
                    ...
                    class="flex rounded items-center py-2 px-4 bg-orange-500 hover:bg-orange-700 text-white">
                ...
                <button
                    ...
                    class="flex rounded items-center py-2 px-4 bg-red-600 hover:bg-red-800 text-white">
